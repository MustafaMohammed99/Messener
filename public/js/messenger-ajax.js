$('.chat-form').on('submit', function (e) {
    e.preventDefault();
    console.log($(this).find('input[name="conversation_id"]').val());
...
const addMessage = function (msg, classMessge = '') {
    $('#message-sending').append(`  <div class="message ${classMessge} ">
    ...
    <div class="message-inner">
        ...
        <div class="message-footer">
            <span
                class="extra-small text-muted">jusn now</span>
        </div>
    </div>
    </div>`);
}
...
const getConversation= function(chats){
