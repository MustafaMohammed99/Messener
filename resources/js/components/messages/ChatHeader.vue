                        ...
                        <div class="row align-items-center gx-5">
                            <div class="col-auto">
                                <div class="avatar d-none d-xl-inline-block"
                                    :class="{ 'avatar-online': (this.$root.conversation.participants[0].isOnline ?? false) }">
                                    <img class="avatar-img"
                                        v-bind:src="this.$root.conversation ? this.$root.conversation.participants[0].avatar_url : ''"
                                        alt="">
                                </div>
                            </div>

                            <div class="col overflow-hidden">
                                <h5 class="text-truncate">{{ this.$root.conversation ?
                                    this.$root.conversation.participants[0].name : '' }}</h5>
                                <p v-if="this.$root.conversation.participants[0].isTyping" class="text-truncate">is typing<span
