...
<body>
                                                ...
                                                <div class="row gx-5">
                                                    ...
                                                    <div class="col">
                                                        <div class="d-flex align-items-center mb-3">
                                                            ...
                                                            <span
                                                                class="text-muted extra-small ms-2">{{ $chat->lastMessage->created_at->diffForHumans() }}
                                                            </span>
                                                        </div>
                ...
                <div class="d-flex flex-column h-100 position-relative">
                    ...
                    <div class="chat-body hide-scrollbar flex-1 h-100">
                        <div class="chat-body-inner">
                            <div class="py-6 py-lg-12" id="message-sending">
                    ...
                    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                        ...
                        <form class="chat-form rounded-pill bg-dark" method="POST"
                            action="{{ route('api.messages.store') }}" data-emoji-form="">
                            <div class="row align-items-center gx-0">
                                @csrf
    ...
    <script>
        ...
        var pusher = new Pusher('0d63c843c863e208c405', {
            cluster: 'eu',
